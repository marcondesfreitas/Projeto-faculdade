...
function button1(){
    $id = parse_url($_SERVER["REQUEST_URI"], PHP_URL_QUERY);
    $sql_del = "DELETE FROM material where Id = ".$id."";
...
<body>
    <h1>Tem certeza que deseja excluir o material? </h1>
    <div class="material">  
        <div class="titulo">
            <h3 style="text-alling: center; position: relative; left: 15%;">Nome do material: </h3><br><h2><?php echo $list["Titulo"];?></h2>
        </div>
        <?php
