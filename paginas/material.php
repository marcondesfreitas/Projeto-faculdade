...
if(isset($_POST['catg']) && $_POST['catg'] == "Todos"){
    ...
    $sql = "SELECT * FROM material ORDER BY Data DESC";
    $query= mysqli_query($conexao, $sql);
    $total = mysqli_num_rows($query);
}else if(isset($_POST['catg'])){
    $categoria = $_POST['catg'];
    $sql = "SELECT * FROM material where Categoria = '$categoria'  ORDER BY Data DESC";
    $query= mysqli_query($conexao, $sql);
    $total = mysqli_num_rows($query);
}else if(isset($_SESSION['Page']) and $_SESSION['Page'] == "material"){
...
<head>
    ...
    <title>Material de Estudos</title>
</head>
<body>
    <section>
        <header>
            <div class="menu">
                <ul>
                    <span style="display: none;" id="span">me</span>
        ...
        <div class="fundo">
            <img src="../imagens/materialimage.svg" class="ft1" id="ft1" draggable="false">
        </div>
        <div class="titulo" id="titulo">
            <img id="tit_img" src="../imagens/materialtexto.svg" alt=""  draggable="false">
            <div class="box"></div>
        </div>
        <article id="article">
            <div class="escopo">
                <div class="filtro">
                    <div class="barra">
                        <form action="../php/db_pesquisa.php" method="post">
                            ...
                            <input type="text" name="page" value="material" style="display: none;">
                ...
                <?php
                    if($_SESSION['Adm'] == true){
                        echo "
                            <div class='add'>
                                <h5><a href='add_material.php'>Adicionar Novo Material <span class='plus'>+</span></a></h5>
                            </div>
                        ";
                    }
                ?>
                    ...
                    ?>
                                <div class="bloco">
                                    ...
                                    ?>
                                        <div class="CRUD">
                                            <div class="editar">
                                                <a href="../php/db_editar_material.php?<?php echo $valor["Id"];?>"><img src="../imagens/edit.svg" width="100%" height="100%"></a>
                                            </div>
                                            <div class="excluir">
                                                <a href="../php/db_excluir_material.php?<?php echo $valor["Id"];?>"><img src="../imagens/trash.svg"></a>
                                            </div>
                                        </div>
                                    <?php
                                        }
